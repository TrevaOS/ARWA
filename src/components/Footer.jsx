      ...
      <div className="footer-body container">
        ...
        <div className="footer-brand">
          ...
          <div className="footer-social">
            <a href="https://www.instagram.com/attiguppe_residents?igsh=bXkxMWF0Z292MTNn" target="_blank" rel="noopener noreferrer" className="social-btn" aria-label="Instagram">
            ...
            <a href="https://wa.me/91XXXXXXXXXX" target="_blank" rel="noopener noreferrer" className="social-btn" aria-label="WhatsApp">
